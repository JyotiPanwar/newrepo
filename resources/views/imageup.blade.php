    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-12">
            @if (Session::has('imgname'))
               <div class="alert alert-info">Original Image:<img src="{{ URL::to('/') }}/images/{{Session::get('imgname')}}"> <!-- <img src="https://s3.ap-south-1.amazonaws.com/ucreate-demo-clone/jyoti/{{Session::get('imgname')}}"> --></div>
            @endif
        </div>
    </div>
</div>
